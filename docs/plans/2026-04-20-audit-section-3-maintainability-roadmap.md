...
> **Единый реестр долга (2026-04-22).** Все открытые пункты этого roadmap,
> хвосты завершённых фаз и вскрытые продуктовые вопросы консолидированы в
> [`docs/backlog.md`](../backlog.md) (IDs `BL-XXX`). При добавлении новой
> задачи сюда, а не в roadmap, — чтобы roadmap оставался «планом фаз», а
> backlog.md — «оперативным реестром остатков».
