...
const FAQSection: React.FC = () => {
  ...
  const faqItems: FAQItem[] = [
    ...
    },
    {
      ...
      answer: 'Стоимость проекта зависит от мощности теплопотребления объекта. Базовая стоимость начинается от 30 000 рублей. Для расчета точной стоимости воспользуйтесь нашим калькулятором на сайте или свяжитесь с нашими специалистами.'
    },
    {
