  ...
  const faqItems: FAQItem[] = [
    {
      ...
      answer: 'Стандартный срок выполнения проекта узла учета тепловой энергии - 3 рабочих дня с момента оплаты и предоставления всех необходимых исходных данных. При необходимости, возможно ускорение до 1-2 дней за дополнительную плату.'
    },
    {
      question: 'Сколько стоит проект УУТЭ?',
      answer: 'Стоимость проекта зависит от мощности теплопотребления объекта. Базовая стоимость начинается от 20 000 рублей. Для расчета точной стоимости воспользуйтесь нашим калькулятором на сайте или свяжитесь с нашими специалистами.'
    },
    {
